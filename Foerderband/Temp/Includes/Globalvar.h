...
#ifndef _BUR_1605105052_2_
#define _BUR_1605105052_2_
...
/* Constants */
 ...
 #define heat_timer_time 12000
 #define timer_error_motor_an_time 10000
 #define timer_error_stopper_time 200
 #define time_blink_fast 175
 #define time_blink_middle 375
 #define time_blink_slow 700
 #define time_5_s_timer 5000
#else
 _GLOBAL_CONST signed short timer_2s_time;
 _GLOBAL_CONST signed short heat_timer_time;
 _GLOBAL_CONST signed short timer_error_motor_an_time;
 _GLOBAL_CONST signed short timer_error_stopper_time;
 _GLOBAL_CONST signed short time_blink_fast;
 _GLOBAL_CONST signed short time_blink_middle;
 _GLOBAL_CONST signed short time_blink_slow;
 _GLOBAL_CONST signed short time_5_s_timer;
#endif


/* Variables */
_GLOBAL signed short AI_Messwandler_2;
_GLOBAL signed short AI_Messwandler;
_GLOBAL plcbit DO_Leistung;
_GLOBAL plcbit DO_Heizung;
...
_GLOBAL struct TON timer_5s;
_GLOBAL plcbit error_flag;
_GLOBAL plcbit set_error_state;
