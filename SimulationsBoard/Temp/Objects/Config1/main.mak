...
export AS_PROJECT_PATH := D:/ia/SimulationsBoard
export AS_PROJECT_NAME := SimulationsBoard
export AS_SYSTEM_PATH := C:/AutomationStudio/AS/System
export AS_VC_PATH := C:/AutomationStudio/AS47/AS/VC
export AS_TEMP_PATH := D:/ia/SimulationsBoard/Temp
export AS_CONFIGURATION := Config1
export AS_BINARIES_PATH := D:/ia/SimulationsBoard/Binaries
...
export WIN32_AS_PROJECT_PATH := "D:\ia\SimulationsBoard"
export WIN32_AS_SYSTEM_PATH := "C:\AutomationStudio\AS\System"
export WIN32_AS_VC_PATH := "C:\AutomationStudio\AS47\AS\VC"
export WIN32_AS_TEMP_PATH := "D:\ia\SimulationsBoard\Temp"
export WIN32_AS_BINARIES_PATH := "D:\ia\SimulationsBoard\Binaries"
...
ProjectMakeFile:
	...
	@'$(AS_BIN_PATH)/BR.AS.AnalyseProject.exe' '$(AS_PROJECT_PATH)/SimulationsBoard.apj' -t '$(AS_TEMP_PATH)' -c '$(AS_CONFIGURATION)' -o '$(AS_BINARIES_PATH)'   -sfas -buildMode 'Build'   
